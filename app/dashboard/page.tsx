    ...
    <section className="flex-1 bg-[#F7FBFC] w-full h-full">
      ...
      <div className="px-11 py-3 w-full">
        <div className="flex w-full items-center justify-between">
          <div className="bg-[#7BBBB2] rounded-sm h-[185px] shadow-md border w-[48%]"></div>
          <div className="bg-white rounded-sm h-[185px] shadow-md border w-[48%]"></div>
        </div>

        <div className="grid items-center justify-between mt-8 grid-cols-3 gap-4">
          <div className="bg-white shadow-md rounded-sm border w-[335px] h-60"></div>
          <div className="bg-white shadow-md rounded-sm border w-[335px] h-60"></div>
          <div className="bg-white shadow-md rounded-sm border w-[335px] h-60"></div>
        </div>
      </div>
