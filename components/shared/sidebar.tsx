...
export default function Sidebar({ sidebarItems, value }: SidebarProps) {
  ...
  return (
    <main className="w-full min-h-screen bg-custom-green-3 pt-6 px-20 relative flex items-start gap-10">
      <section className="flex flex-col items-start gap-10 w-1/3">
